				...
				<WebWrapper>
					<View className="gap-10 p-4">
						<Text className="text-lg">
							Need help with RecordScratch? We're here to assist
							you. Choose your preferred method of contact below.
						</Text>
						<View className="items-start gap-4">
							...
							<View>
								<Text className="text-muted-foreground text-lg">
									• Real-time support from our team and
									community
								</Text>
								<Text className="text-muted-foreground text-lg">
						...
						<View className="items-start gap-4">
							...
							<Text className="text-lg">
								For other inquiries, you can reach us via email.
								We typically respond within 24-48 hours.
							</Text>
							<Button
								onPress={() =>
									openUrl(`mailto:${socials.email}`)
								}
								variant="outline"
								className="flex-row items-center gap-3"
							>

import { Check, ChevronDown, ChevronUp } from "@/lib/icons/IconsLoader";
import { cn } from "@/lib";
...
>(({ className, ...props }, ref) => (
	<SelectPrimitive.Label
		ref={ref}
		className={cn(
			"native:pb-2 native:pl-10 native:text-base py-1.5 pl-8 pr-2 font-semibold text-sm text-popover-foreground",
			className,
		)}
		{...props}
	/>
